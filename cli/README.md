...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 linux-x64 node-v14.17.5
...
_See code: [dist/commands/hello/index.ts](https://github.com/JustalK/hello-world/blob/v0.0.0/dist/commands/hello/index.ts)_
